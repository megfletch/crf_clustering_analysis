...
aguion_table <- aguion_barnacle %>% 
  select("new_importance", "score_value", "attribute") %>% 
  group_by(score_value, new_importance) %>% 
  summarize(attribute = str_c(attribute)) %>% 
  pivot_wider(names_from = c(new_importance), values_from = attribute, values_fn = list) %>% 
  rename(" " = score_value) 
...
aguion_table %>% 
  ...
  add_header_above(c(" ", "Score Levels" = 3)) # %>% save_kable("aguion_attribute_table.png")
```
...
```{r}
### Go up to code above and ifx once columns have been completed

burden_table <- burden_sardine %>% 
  select("importance", "score_value", "attribute") %>% 
  group_by(score_value, importance) %>% 
  summarize(attribute = str_c(attribute)) %>% 
  pivot_wider(names_from = c(importance), values_from = attribute, values_fn = list) %>% 
  rename(" " = score_value) 
...
burden_table %>% 
  kbl(caption = "Burden Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) #%>% save_kable("burden_attribute_table.png")
```
...
dickey_collas_table %>% 
  kbl(caption = "Dickey-Collas Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 4)) #%>% save_kable("dickey_collas_attribute_table.png")
```
...
eurich_table %>% 
  kbl(caption = "Eurich Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 3)) #%>% save_kable("eurich_attribute_table.png")
```
...
free_table %>% 
  kbl(caption = "Free Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 3)) #%>% save_kable("free_attribute_table.png")
```
...
friedman_table %>% 
  kbl(caption = "Friedman Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 4)) #%>% save_kable("friedman_attribute_table.png")
```
...
hollowed_table %>% 
  kbl(caption = "Hollowed Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 3)) #%>% save_kable("hollowed_attribute_table.png")
```
...
kisara_table %>% 
  kbl(caption = "Kisara Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 4)) #%>% save_kable("kisara_attribute_table.png")
```
...
kleisner_table %>% 
  kbl(caption = "Kleisner Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 3)) #%>% save_kable("kleisner_attribute_table.png")
```
...
lau_table %>% 
  kbl(caption = "Lau Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 4)) #%>% save_kable("lau_attribute_table.png")
```
...
mason_table %>% 
  kbl(caption = "Mason Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 3)) #%>% save_kable("mason_attribute_table.png")
```
...
mills_table %>% 
  kbl(caption = "Mills Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 4)) #%>% save_kable("mills_attribute_table.png")
```
...
pecl_table %>% 
  kbl(caption = "Pecl Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 3)) #%>% save_kable("pecl_attribute_table.png")
```
...
tokunaga_table %>% 
  kbl(caption = "Tokunaga Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 3)) #%>% save_kable("tokunaga_attribute_table.png")
```
...
westfall_table %>% 
  kbl(caption = "Westfall Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 4)) #%>% save_kable("westfall_attribute_table.png")
```
...
zhao_table %>% 
  kbl(caption = "Zhao Attribtue Table") %>% 
   kable_classic_2(full_width = F, html_font = "Cambria") %>% 
  kable_styling(bootstrap_options = c("striped", "hover")) %>% 
  add_header_above(c(" ", "Score Levels" = 3)) #%>% save_kable("zhao_attribute_table.png")
```
